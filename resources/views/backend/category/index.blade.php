                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('images/' . $category->image)}}" alt="" width="150" /></td>
                                            <td>{{$category->title}}</td>
                                            <td>{!! nl2br($category->detail) !!}</td>
                                            <td>
                                                <a class="btn btn-sm btn-primary" href="{{ url('admin/category/' . $category->id . '/edit') }}">Update</a>
                                                <a class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?');" href="{{ url('admin/category/' . $category->id . '/delete') }}">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
